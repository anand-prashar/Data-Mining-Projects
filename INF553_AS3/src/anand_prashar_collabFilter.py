...
userIndex = []; movieIndex = []; utilityMatrix = []
...
def readCommandLine():
    ...
    try:
        fHandle = open('ratings-dataset.tsv')
    except:
    ...
    cmdlineUser  = '8ccfa5d6-6f0b-407f-a463-0e1f745f9dad'#sys.argv[2]
    cmdlineMovie = 'The Fugitive'#sys.argv[3]
    try:
        cmdlineK = 30#int(sys.argv[4])
    except:
